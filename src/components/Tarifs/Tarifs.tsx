    ...
    <div className='tarifs'>
      ...
      <div className='tarifs__content'>
        <div className='tarifs__section'>
          <h3 className='tarifs__section-title'>Pour les humains</h3>
          <div className='tarifs__items'>
            ...
            <div className='tarifs__item tarifs__item--child'>
              <span className='tarifs__item-label'>Séance enfant (jusqu'à 16 ans)<br/>pour le Reiki et l'harmonisation globale</span>
        ...
        <div className='tarifs__section'>
          <h3 className='tarifs__section-title'>Pour les animaux</h3>
          <div className='tarifs__items'>
            <div className='tarifs__item'>
        ...
        <div className='tarifs__section tarifs__section--packages'>
          ...
          <div className='tarifs__items'>
            <div className='tarifs__item tarifs__item--package'>
              <span className='tarifs__item-label'>En duo : 1 soin Reiki ou Harmonisation globale + Kinésiologie animale</span>
